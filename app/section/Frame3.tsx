      ...
      <div className="w-96 inline-flex flex-col justify-start items-center gap-20">
        <div className="self-stretch flex flex-col justify-start items-center gap-12">
          ...
          <div className="w-72 flex flex-col justify-start items-center gap-3.5">
            <div className="self-stretch text-center justify-start text-stone-700 text-2xl font-normal font-['Aroma_Beauty'] leading-loose">
              DISKA AYU ZUNAIDA
            </div>
            <div className="self-stretch text-center justify-start text-stone-700 text-3xl font-normal font-['Gustatory_Delight']">
              dengan
            </div>
            <div className="self-stretch text-center justify-start text-stone-700 text-2xl font-normal font-['Aroma_Beauty'] leading-loose">
