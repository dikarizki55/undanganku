      ...
      <div className="flex-1 self-stretch pt-20 pb-11 inline-flex flex-col justify-between items-center">
        <div className="self-stretch flex flex-col justify-start items-start gap-20">
          ...
          <div className="self-stretch h-24 flex flex-col justify-start items-center gap-2">
            ...
            <div className="self-stretch flex-1 text-center justify-start text-stone-700 text-5xl font-normal font-gustato leading-10 mt-2">
              Diska & Dika
            </div>
            <div className="self-stretch text-center justify-start text-stone-700 text-xs font-normal font-spectral leading-none">
              Beserta Keluarga
        ...
        <div className="self-stretch text-center justify-start text-stone-700 text-xs font-normal font-spectral leading-3">
          Web buatan Dika
        </div>
      </div>
    </div>
